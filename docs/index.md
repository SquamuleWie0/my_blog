...
<div style="position: relative; text-align: center; padding: 4rem 1rem 2.5rem; background: linear-gradient(180deg, #fff8e8 0%, #fce4b8 45%, #f5a05e 100%); border-radius: 12px; margin-bottom: 2rem; overflow: hidden;">

<!-- 太阳 SVG，右上角 -->
<svg style="position: absolute; top: 50px; right: 50px; width: 100px; height: 100px; opacity: 0.7;" viewBox="0 0 100 100">
  <defs>
    <radialGradient id="sunGlow">
      <stop offset="0%" stop-color="#fff8dc" stop-opacity="1" />
      <stop offset="50%" stop-color="#ffd76b" stop-opacity="0.6" />
      <stop offset="100%" stop-color="#ffaa44" stop-opacity="0" />
    </radialGradient>
  </defs>
  <circle cx="50" cy="50" r="48" fill="url(#sunGlow)" />
  <circle cx="50" cy="50" r="18" fill="#fff8dc" opacity="0.9" />
</svg>
