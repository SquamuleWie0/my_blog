...
<div style="text-align: center; padding: 4rem 1rem 3rem;">
  <h1 style="margin: 0.5rem 0; font-family: 'Caveat', cursive; font-weight: 700; font-size: 5rem; line-height: 1.1; background: linear-gradient(135deg, #d77da5 0%, #e8a0bd 50%, #f4c1d4 100%); -webkit-background-clip: text; background-clip: text; color: transparent; letter-spacing: -0.02em;">Wie0</h1>
